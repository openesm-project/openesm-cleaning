...
# Data --------------------------------------------------------------------
if(!file.exists(here("data", "raw", "0001_fried.csv"))){
  ...
  file.rename(here("data", "raw", file_name), here("data", "raw", "0001_fried_raw.csv"))
}

df <- read.csv(here("data", "raw", "0001_fried_raw.csv"))
...
if(check_results == "Data are clean."){
  write_tsv(df, here("data", "clean", "0001_fried.tsv"))
}
